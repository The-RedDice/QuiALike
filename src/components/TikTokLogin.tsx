    ...
    <form onSubmit={handleSubmit} className="space-y-6 w-full">
      ...
      <div className="space-y-2">
        <input
          ...
          placeholder="@pseudo"
          className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#fe2c55]/20 focus:border-[#fe2c55] transition-all bg-white"
          disabled={isLoading}
        />
      ...
      <button
        ...
        className="w-full py-4 rounded-2xl font-bold flex items-center justify-center gap-3 transition-all bg-[#fe2c55] text-white hover:opacity-90 active:scale-[0.98] shadow-lg shadow-[#fe2c55]/20 disabled:opacity-50 disabled:active:scale-100"
      >
        {isLoading ? (
